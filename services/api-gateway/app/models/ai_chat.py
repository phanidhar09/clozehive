...
class AIChatSession(Base):
    ...
    summary_through_msg_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default="0")
...
class DailyNudge(Base):
    ...
    __table_args__ = (UniqueConstraint("user_id", "nudge_date", name="uq_daily_nudges_user_date"),)
