...
async def send_message(
    ...
    # ChatContext carries no weather condition (only `location`). Storing the
    # location here poisoned the weather field of the RAG embedding, so weather
    # searches never matched. Leave it blank until real weather is available.
