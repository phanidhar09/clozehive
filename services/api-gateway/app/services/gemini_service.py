...
3. OVERLAPPING layers: jacket worn over shirt → 2 entries with overlapping bboxes \
   (outer layer has higher x_min/y_min coverage; inner layer bbox tighter).

4. PARTIAL visibility: include items that are >10% visible (shoe at frame edge, \
   belt peeking out, bag strap showing). Mark as segmentation_quality "low".
...
METADATA RULES:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
• detection_confidence: 0.0–1.0 per item (visibility × identification certainty).
• Only output items with detection_confidence ≥ 0.35.
• segmentation_quality: "high" (clean edges), "medium" (some blur/occlusion), \
  "low" (partial, heavily occluded).
• brand: null unless logo/text is CLEARLY and FULLY readable.
• Use null (not "") for truly unknown fields. Never guess.
• occasions/season/style_tags: realistic lists based on what you can see.
