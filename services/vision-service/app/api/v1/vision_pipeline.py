"""
Vision Pipeline endpoints — /api/v1/
...
POST  /closet/{item_id}/remove-background Retry background removal for a saved item.
"""
...
from app.services import cache_service, similarity_service, vision_pipeline_service
from app.services.background_removal_service import remove_background_async
from app.services.upload_service import persist_upload, read_upload_bytes, read_validated_image
...
# ── POST /closet/{item_id}/remove-background ──────────────────────────────────

@router.post(
    "/closet/{item_id}/remove-background",
