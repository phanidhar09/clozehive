...
# ── Standard single-item analysis ─────────────────────────────────────────────

@traceable(name="vision_analyze_image", run_type="chain")
...
@traceable(name="vision_analyze_for_bulk", run_type="chain")
