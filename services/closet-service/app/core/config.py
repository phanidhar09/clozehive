...
class Settings(BaseSettings):
    # ── App ───────────────────────────────────────────────────────────────────
    app_name: str = "CLOZEHIVE Closet Service"
    ...
    # ── Inter-service (identity gateway seam) ─────────────────────────────────
    # Base URL of the api-gateway for the rare internal calls that need user
    # account details (e.g. GET /internal/users/{id}). Hot-path auth is local
    # JWT validation, so this is only used off the request path.
