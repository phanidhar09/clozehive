...
export const DUMMY_ITEMS: ClosetItem[] = [
  {
    id: 'item-001', user_id: 1, name: 'White Oxford Shirt', category: 'tops',
  ...
  {
    id: 'item-002', user_id: 1, name: 'Navy Slim Chinos', category: 'bottoms',
  ...
  {
    id: 'item-003', user_id: 1, name: 'Black Turtleneck', category: 'tops',
  ...
  {
    id: 'item-004', user_id: 1, name: 'White Sneakers', category: 'shoes',
  ...
  {
    id: 'item-005', user_id: 1, name: 'Beige Trench Coat', category: 'outerwear',
  ...
  {
    id: 'item-006', user_id: 1, name: 'Floral Midi Dress', category: 'dresses',
  ...
  {
    id: 'item-007', user_id: 1, name: 'Charcoal Blazer', category: 'outerwear',
  ...
  {
    id: 'item-008', user_id: 1, name: 'Dark Wash Jeans', category: 'bottoms',
  ...
  {
    id: 'item-009', user_id: 1, name: 'Silk Slip Dress', category: 'dresses',
  ...
  {
    id: 'item-010', user_id: 1, name: 'Tan Leather Belt', category: 'accessories',
  ...
  {
    id: 'item-011', user_id: 1, name: 'Olive Utility Jacket', category: 'outerwear',
  ...
  {
    id: 'item-012', user_id: 1, name: 'White Stan Smith', category: 'shoes',
  ...
  {
    id: 'item-013', user_id: 1, name: 'Cashmere Crewneck', category: 'tops',
