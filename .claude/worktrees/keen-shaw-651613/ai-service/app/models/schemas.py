...
class VisionAnalysisResponse(BaseModel):
    ...
    raw_description: str = ""
    # Background-removed image (base64 PNG) — empty when unavailable
    processed_image_base64: str = ""
    processed_image_media_type: str = "image/png"


class DetectedOutfitItem(BaseModel):
    """A single clothing item detected in a full-body / outfit photo."""
    garment_type: str = ""
    suggested_name: str = ""
...
class OutfitAnalysisResponse(BaseModel):
    """Response for analysing a full-body / outfit photo."""
    is_outfit_photo: bool = True
    items: List[DetectedOutfitItem] = []
    # Background-removed version of the uploaded photo (base64 PNG)
    processed_image_base64: str = ""
    processed_image_media_type: str = "image/png"
