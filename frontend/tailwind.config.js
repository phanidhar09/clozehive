  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        // fAnI brand loader (letters pop in/out, dot per letter, star on I)
        'fani-letter':   'faniLetter 3s ease-in-out infinite',
        'fani-dot':      'faniDot 3s ease-in-out infinite',
        'fani-star':     'faniStar 3s ease-in-out infinite',
        'fani-glow':     'faniGlow 3s ease-in-out infinite',
      },
      keyframes: {
        ...
        faniLetter: {
          '0%':   { opacity: '0', transform: 'translateY(16px) scale(.55)', filter: 'blur(4px)' },
          '10%':  { opacity: '1', transform: 'translateY(-3px) scale(1.08)', filter: 'blur(0)' },
          '15%':  { transform: 'translateY(0) scale(1)' },
          '70%':  { opacity: '1', transform: 'translateY(0) scale(1)', filter: 'blur(0)' },
          '82%':  { opacity: '0', transform: 'translateY(-16px) scale(.55)', filter: 'blur(4px)' },
          '100%': { opacity: '0', transform: 'translateY(-16px) scale(.55)', filter: 'blur(4px)' },
        },
        faniDot: {
        ...
        faniStar: {
          ...
          '82%':  { opacity: '0', transform: 'scale(.3) rotate(25deg)' },
