...
export const DASHBOARD_QUICK_ACTIONS: {
  ...
  { label: 'FANI AI Stylist', desc: 'Get AI styling advice',   icon: Sparkles,  to: '/ai-stylist',     gradient: 'from-brand-500 to-brand-600' },
  { label: 'My Closet',       desc: 'Browse your wardrobe',    icon: Shirt,     to: '/closet',         gradient: 'from-brand-600 to-blue-600'    },
