...
// NOTE: the legacy `streamChat` SSE client (POST /ai/chat/stream) was removed —
// all chat UIs now use `streamMessage` in services/aiChatApi.ts, which consumes
// the gated /ai-chat/stream path (model router, RAG, grounding gate, telemetry).
